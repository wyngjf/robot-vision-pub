...
import sys
sys.path.append("./aot")
from robot_vision.sam_track.aot.networks.engines.aot_engine import AOTEngine,AOTInferEngine
from robot_vision.sam_track.aot.networks.engines.deaot_engine import DeAOTEngine,DeAOTInferEngine
import importlib
import numpy as np
...
import robot_vision.sam_track.aot.dataloaders.video_transforms as tr
from robot_vision.sam_track.aot.utils.checkpoint import load_network
from robot_vision.sam_track.aot.networks.models import build_vos_model
from robot_vision.sam_track.aot.networks.engines import build_engine
...
def get_aot(args):
    # build vos engine
    from robot_vision.sam_track.aot.configs.pre_ytb_dav import EngineConfig
